...
Clawmapper is a GitHub template. Your roadmap lives as plain Markdown in its own repo — same stack as your code, fully self-contained. Claude Code is the assistant — you describe what's shipping, what changed, what needs a slide. It handles the structure and commits everything. Git keeps the history.
